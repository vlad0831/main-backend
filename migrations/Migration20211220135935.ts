...
export class Migration20211220135935 extends Migration {
  async up(): Promise<void> {
    this.addSql(
      'alter table "managed_fund" alter column "allio_fund_id" type varchar(255) using(allio_fund_id::varchar);'
    );
  ...
  async down(): Promise<void> {
    this.addSql('drop table if exists "user_investment_fund"');
  }
}
